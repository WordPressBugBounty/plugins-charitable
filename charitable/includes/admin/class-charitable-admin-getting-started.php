...
class Charitable_Admin_Getting_Started {
	...
	public function output() {
		...
		if ( class_exists( 'Charitable_Gateway_Stripe_AM' ) ) {
			...
			$redirect_url       = admin_url( 'index.php?page=charitable-getting-started' );
			...
			<div class="container">
				...
				<div class="intro">
					...
					<a href="#" class="play-video" title="<?php esc_attr_e( 'Watch to learn more about Charitable', 'charitable' ); ?>">
						<img src="<?php echo charitable()->get_path( 'assets', false ); ?>/images/onboarding/getting-started/video-poster.jpg" alt="<?php esc_attr_e( 'Watch how to create your first campaign', 'charitable' ); ?>" class="video-thumbnail">
					</a>

					<div class="block">

						<h6><?php esc_html_e( 'Charitable makes it easy to build campaigns and accept donations. You can create your first campaign right now or read our documentation to make the most of Charitable.', 'charitable' ); ?></h6>
						...
						<div class="charitable-button-wrap charitable-clear">
							...
							<div class="right">
								<a target="_blank" href="<?php echo esc_url( charitable_utm_link( 'https://wpcharitable.com/documentation/', 'welcome-page', 'View Documentation' ) ); ?>"
									class="charitable-button-link charitable-button-orange" target="_blank" rel="noopener noreferrer">
									<?php esc_html_e( 'View Documentation', 'charitable' ); ?>
								</a>
							</div>
						</div>
					...
					<div class="block">
						...
						<?php if ( $stripe_connect_url ) : ?>
							<div class="charitable-sub-container charitable-connect-stripe">
								...
								<div>
									<a href="<?php echo admin_url( 'admin.php?page=charitable-settings&tab=gateways&group=gateways_stripe' ); ?>  " class="charitable-button-link charitable-button-orange"><?php esc_html_e( 'Connected', 'charitable' ); ?></a>
								</div>
